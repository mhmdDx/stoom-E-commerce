...
import { ProductType } from "@/companents/Types";
...
const ProductInteraction = ({
  ...
  const { addToCart, hasHydrated } = useCartStore();
  ...
  return (
    <div className="flex flex-col gap-4 mt-4">
      ...
      <button
        ...
        disabled={!isHydrated}
        className={`px-4 py-2 rounded-md shadow-lg flex items-center justify-center gap-2 text-sm font-medium ${isHydrated
